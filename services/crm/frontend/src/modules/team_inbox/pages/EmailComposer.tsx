...
${forwardMessage.content}
      ...
      if (contentRef.current) {
        contentRef.current.innerHTML = forwardBlockHtml;
  ...
  }, [to, subject, content, htmlContent, cc, bcc]);
  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-2xl flex flex-col max-h-[90vh] ${
        isMaximized ? "fixed inset-4" : "w-full max-w-4xl"
      }`}
    >
      {/* Header */}
